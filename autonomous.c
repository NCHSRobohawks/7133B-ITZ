...
#pragma config(Sensor, in5,    base,           sensorPotentiometer)
#pragma config(Sensor, in6,    lift,           sensorPotentiometer)
#pragma config(Sensor, in7,    manipulator,    sensorPotentiometer)
#pragma config(Sensor, dgtl1,  R,              sensorQuadEncoder)
#pragma config(Sensor, dgtl3,  L,              sensorQuadEncoder)
#pragma config(Motor,  port1,           mogo,          tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           manipulatorL,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           manipulatorR,  tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port8,           baseLfront,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           baseRback,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          baseRfront,    tmotorVex393_HBridge, openLoop)
...
task third(){
	...
	wait1Msec(200);
	dr4b(0);
	 startTask(manipulator_in);//change
	 wait1Msec(250);
	 lift_lower(1630);
	 motor[rollers] = 127;
	 wait1Msec(300);
